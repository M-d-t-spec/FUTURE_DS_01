...
- **CSV File:** `ecommerce_data.csv` containing:
  - Order IDs
  - Customer IDs
  - Product description
...
- DAX measure creation (Total Sales, Total Orders, Average Order Value)  
- Dashboard design and storytelling  
- Business focused insights for ecommerce performance
